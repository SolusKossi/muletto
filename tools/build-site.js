  ...
  return `  <footer class="site">
    <div class="wrap">
      ...
      <div class="foot-links">
        ...
        ${COMMIT ? `<a class="foot-commit" href="https://github.com/SolusKossi/muletto/commit/${COMMIT}" target="_blank" rel="noopener noreferrer" title="The commit this site was built from">build ${COMMIT}</a>` : ""}
      </div>
    </div>
  </footer>`;
}
